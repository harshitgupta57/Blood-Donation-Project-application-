...
public class DonorActivity extends AppCompatActivity {
    ...
    private TextInputEditText registername,phonenumber,emailid,enteraddress ,enterpassword;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_donor_acitivity);
...
//        uniquedonoruniqueid = findViewById(R.id.enteruniqueid);
...
//                final  String Uniqueid = uniquedonoruniqueid.getText().toString().trim();
...
//                {
//                    uniquedonoruniqueid.setError("Id Requried ! ");
//                    return;
//                }
...
//                                 userinformation.put("UniqueId",uniquedonoruniqueid);
                                 userinformation.put("bloodgroup",blood);
                                 userinformation.put("type","donor");
                                 userinformation.put("search","donor"+blood);
                                 ...
                                 userdatabase.updateChildren(userinformation).addOnCompleteListener(new OnCompleteListener() {
                                     ...
                                     public void onComplete(@NonNull Task task) {
                                         ...
                                         if (task.isSuccessful())
                                         {
                                             Toast.makeText(DonorActivity.this, "Registered successfully", Toast.LENGTH_SHORT).show();
                                         }
                                         else
                                         {
                                  ...
                                  if (profileuri!=null)
                                  {
                                      ...
                                      uploadTask.addOnFailureListener(new OnFailureListener() {
                                          ...
                                          public void onFailure(@NonNull Exception e) {
                                              Toast.makeText(DonorActivity.this, "Image upload failed", Toast.LENGTH_SHORT).show();
                                                      ...
                                                      public void onSuccess(Uri uri) {
                                                          ...
                                                          userdatabase.updateChildren(newimagemap).addOnCompleteListener(new OnCompleteListener() {
                                                              ...
                                                              public void onComplete(@NonNull Task task) {
                                                                  if (task.isSuccessful())
                                                                  {
                                                                      Toast.makeText(DonorActivity.this, "Image url Successfull stored to database", Toast.LENGTH_SHORT).show();
                                                                  }
                                                                  else
                                                                  {
                                                                      Toast.makeText(DonorActivity.this, task.getException().toString(), Toast.LENGTH_SHORT).show();
